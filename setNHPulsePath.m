...
%   verbose         : print a short summary [true]
    ...
    localSpmRoots = nhpulseFindLocalDependencyRoots(repoRoot, ...
        {'spm_vol.m', 'spm.m'});
    localIso2meshRoots = nhpulseFindLocalDependencyRoots(repoRoot, ...
        {'vol2mesh.m', 'surf2mesh.m', 'cgalv2m.m'});
    localCvxRoots = nhpulseFindLocalDependencyRoots(repoRoot, ...
        {'cvx_setup.m', 'cvx_begin.m'});
    localNiftiRoots = nhpulseFindLocalDependencyRoots(repoRoot, ...
