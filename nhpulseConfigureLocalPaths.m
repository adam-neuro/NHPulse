...
function cfg = makeDefaultConfig(opts)
    ...
    localSpmRoots = nhpulseFindLocalDependencyRoots(opts.repoRoot, ...
        {'spm_vol.m', 'spm.m'});
    localIso2meshRoots = nhpulseFindLocalDependencyRoots(opts.repoRoot, ...
        {'vol2mesh.m', 'surf2mesh.m', 'cgalv2m.m'});
    localCvxRoots = nhpulseFindLocalDependencyRoots(opts.repoRoot, ...
        {'cvx_setup.m', 'cvx_begin.m'});
    localNiftiRoots = nhpulseFindLocalDependencyRoots(opts.repoRoot, ...
        {'load_nii.m', 'load_untouch_nii.m'});
