...
function defaults = defaultSubjects(P)
    ...
    defaults = addSyntheticSubject(defaults, P, 'nhpulseSyntheticDemo');
    defaults = addSyntheticSubject(defaults, P, 'nhpulseSyntheticSmoke');
end

function defaults = addSyntheticSubject(defaults, P, subjectId)
    subjectRoot = fullfile(P.outputRoot, 'syntheticMwe', subjectId);
    defaults.(subjectId) = struct( ...
        'aliases', {{'demo', 'synthetic', lower(subjectId)}}, ...
        'root', subjectRoot, ...
        'initialScan', subjectRoot, ...
        'mprageInitial', fullfile(subjectRoot, [subjectId '_T1.nii']), ...
        'output', subjectRoot, ...
        'anatomyWork', fullfile(subjectRoot, 'anatomy'), ...
        'roastWork', fullfile(subjectRoot, 'roast'), ...
        'capWork', fullfile(subjectRoot, 'capMaker'), ...
        'segmentationWork', fullfile(subjectRoot, 'segmentation'));
end
