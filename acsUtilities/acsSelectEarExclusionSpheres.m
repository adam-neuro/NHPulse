...
function [proposal, accepted, fig] = selectEarSpheresGui(TRskin, proposal, opts)
    ...
    uicontrol(fig, ...
        ...
        'String', 'Done', ...
        'Units', 'normalized', ...
        'Position', [0.78 0.19 0.18 0.07], ...
        'Callback', @onDone);
    uicontrol(fig, ...
        'Style', 'pushbutton', ...
        'String', 'Reset proposal', ...
        'Units', 'normalized', ...
        'Position', [0.78 0.10 0.18 0.06], ...
        'Callback', @onReset);
    uicontrol(fig, ...
        'Style', 'pushbutton', ...
        'String', 'Cancel', ...
        'Units', 'normalized', ...
        'Position', [0.78 0.03 0.18 0.05], ...
        'Callback', @onCancel);
